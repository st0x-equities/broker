...
contract CouponExpiryTest is Test, Utils {
    ...
    function test_mintBeforeCouponExpiry() public {
        ...
        vm.stopPrank();
        // uint256 asked_amount = buyAmount * fakeBid;
        // uint256 output_amount;
        // if (asked_amount <= amountLimit){
        //     output_amount = buyAmount;
        //     console2.log("Lesss than amount limit");
        // }
        // output_amount = output_amount * fakeBid;
        assertGt(IERC20(address(flow)).balanceOf(alice), 0);
    }
}